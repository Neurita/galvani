...
.. image:: https://secure.travis-ci.org/neurita/galvani.png?branch=master
    :target: https://travis-ci.org/neurita/galvani

.. image:: https://coveralls.io/repos/neurita/galvani/badge.png
    :target: https://coveralls.io/r/neurita/galvani
...
You can check the latest sources with the command::
    ...
    git clone https://www.github.com/neurita/galvani.git

or if you have write privileges::

    git clone git@github.com:neurita/galvani.git
